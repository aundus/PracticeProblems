/*
Author: Adam Undus
Description: Uses an implementation of Red Black Tree to find the n most common worrds in a supplied text file.
node.h tree.h and testcwf.sh were provided by Dr. Brian Borowski of SIT. 
*/
#include "rbtree.h"
#include <iostream>
#include <sstream>
...
int limit = 10;
//priority_queue<pair<int,Node<string,int>*>> maxHeap;
vector<pair<int,Node<string,int>*>> vec;
//priority_queue<pair<int,Node<string,int>*>, vector<pair<int,Node<string,int>*>>, compPair<pair<int,Node<string,int>*>>> minHeap;
